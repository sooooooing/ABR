 ...
 * \ingroup abr
 *
 * \brief ABR loopback UDP echo test case
 */
 ...
 * \ingroup abr-test
 *
 * \brief ABR Loopback test suite
 */
class AbrLoopbackTestSuite : public TestSuite
{
  public:
    AbrLoopbackTestSuite()
        : TestSuite("routing-abr-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_abrLoopbackTestSuite; ///< the test suite
